                ...
                <div className="collapse navbar-collapse" id="mynavbar">
                    <ul className="navbar-nav me-auto">
                        <li className="nav-item active"><a className="nav-link"
                            href="/">Animaux en adoption<span
                                className="sr-only"></span></a></li>
                        <li className="nav-item"><a className="nav-link" href="">Au
                            hasard ?</a></li>
                        ...
                        <li className="nav-item dropdown"><a
                            ...
                            <ul className="dropdown-menu">
                                <li><a className="dropdown-item" href="">Cadre
                                    de vie</a></li>
                                <li><a className="dropdown-item" href="">Alimentation</a></li>
                            </ul></li>
                    </ul>
                </div>
            </div>
